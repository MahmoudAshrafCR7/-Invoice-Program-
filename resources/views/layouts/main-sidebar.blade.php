		...
		<aside class="app-sidebar sidebar-scroll ">
			<div class="main-sidebar-header active text-light">
                <div class="text-light mt-4">
                    <img style="margin-right: 70px" alt="user-img" class="avatar avatar-xl brround text-center" src="{{URL::asset('assets/img/faces/18.jpg')}}">
                </div>
			</div>
				...
				<ul class="side-menu">
						...
						<ul class="slide-menu">
							...
							<li>
                                ...
                                <li>
                                    ...
                                    <a class="slide-item" href="{{ url('/' . $page='Invoice_UnPaid') }}">الفواتير الغير المدفوعة</a></li>
                                    @endcan

                                    <li>
                                        @can('الفواتير المدفوعة جزئيا')
                                        <a class="slide-item" href="{{ url('/' . $page='Invoice_Partial') }}">الفواتير المدفوعة جزئيا</a></li>
                                        @endcan

                                        <li>
                                            @can('ارشيف الفواتير')
                                            <a class="slide-item" href="{{ url('/' . $page='Archive') }}"> ارشيف الفواتير</a></li>
                                            @endcan
                                        </ul>
                                         @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li>
                                ...
                                <a class="slide-item" href="{{ url('/' . $page='users') }}">قائمة المستخدمين </a></li>
                                @endcan

                                <li>
                                @can('صلاحيات المستخدمين')
                                <a class="slide-item" href="{{ url('/' . $page='roles') }}">صلاحيات المستخدمين</a></li>
                                @endcan
                            </ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li>
                                @can('الاقسام')
                                <a class="slide-item" href="{{ url('/' . $page='sections') }}">الاقسام </a></li>
                                @endcan

                            <li>
                                @can('المنتجات')
                                <a class="slide-item" href="{{ url('/' . $page='products') }}">المنتجات</a></li>
                                @endcan
                            </ul>
					</li>
				</ul>
