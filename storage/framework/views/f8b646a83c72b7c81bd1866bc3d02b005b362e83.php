            ...
            <div class="card mg-b-20">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <a class="modal-effect btn btn-success" data-effect="effect-scale" data-toggle="modal" href="#exampleModal">
                         <i class="fa-solid fa-plus"></i> اضافة منتج
                        </a>
                    </div>
                    <?php endif; ?>
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            data-id="<?php echo e($Product->id); ?>" data-name="<?php echo e($Product->Product_name); ?>"  data-section_name="<?php echo e($Product->section->section_name); ?>"
                                            data-description="<?php echo e($Product->description); ?>" data-toggle="modal" href="#edit_Product"
                                            title="تعديل"><i class="las la-pen"></i></a>

                                         <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                            data-id="<?php echo e($Product->id); ?>" data-product_name="<?php echo e($Product->Product_name); ?>" data-toggle="modal"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Invoices\resources\views/products/products.blade.php ENDPATH**/ ?>