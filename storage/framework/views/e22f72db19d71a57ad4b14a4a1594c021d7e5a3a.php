...
<?php $__env->startSection('page-header'); ?>
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Hi, <?php echo e(Auth::user()->name); ?> welcome back!</h2>
            </div>
        </div>
    </div>
    <!-- /breadcrumb -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Invoices\resources\views/home.blade.php ENDPATH**/ ?>