                                         ...
                                         <div class="form-group row">
                                             <div class="col-md-6 offset-md-4">
                                                  <div class="form-check">
                                                       <input style="position: relative;right:40px" class="form-check-input" type="checkbox" name="remember" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                       <label style="position: absolute;left:10px" class="form-check-label " for="remember">
                                                              <?php echo e(__('remember')); ?>
...
<?php /**PATH D:\Invoices\resources\views/auth/login.blade.php ENDPATH**/ ?>