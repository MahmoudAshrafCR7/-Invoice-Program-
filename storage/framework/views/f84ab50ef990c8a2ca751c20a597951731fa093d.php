...
<?php $__env->startSection('content'); ?>
        ...
        <?php endif; ?>
                    ...
                    <div class="card mg-b-20 col-md-12">
                        <div class="card-header pb-0">

                            <div class="d-flex justify-content-between">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('اضافة قسم')): ?>
                                <a class="modal-effect btn btn-success" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">
                                 <i class="fa-solid fa-plus"></i> اضافة قسم
                                </a>
                                <?php endif; ?>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Invoices\resources\views/sections/sections.blade.php ENDPATH**/ ?>