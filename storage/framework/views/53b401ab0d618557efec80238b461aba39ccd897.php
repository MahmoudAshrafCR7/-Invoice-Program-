                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo e($invoice->invoice_number); ?> </td>
                                                        <td class="text-center"><?php echo e($invoice->invoice_Date); ?></td>
                                                        <td class="text-center"><?php echo e($invoice->due_date); ?></td>
                                                        <td class="text-center"><?php echo e($invoice->product); ?></td>
                                                        <td class="text-center">
                                                            <a
                                                                href="<?php echo e(url('InvoicesDetails')); ?>/<?php echo e($invoice->id); ?>"><?php echo e($invoice->section->section_name); ?>

                                                            </a>
                                                        </td>
                                                        <td class="text-center"><?php echo e($invoice->Discount); ?></td>
                                                        <td class="text-center"><?php echo e($invoice->Rate_Vat); ?></td>
                                                        <td class="text-center"><?php echo e($invoice->Value_Vat); ?></td>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu tx-13">
                                                                    ...
                                                                    <a class="dropdown-item" href=" <?php echo e(url('edit_invoice')); ?>/<?php echo e($invoice->id); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Invoices\resources\views/invoices/invoices.blade.php ENDPATH**/ ?>